...
public class MemberService {
    ...
    public Member setMember(String username, String email, String password) {
        ...
        member.setPassword(passwordEncoder.encode(password)); // 12345 -> quwndiui#@kNKLNI@# 와 같이 암호화
        // 역할 추가
        member.setRole(MemberRole.USER); // 일반 사용자 추가
        // member.setRole("ROLE_USER"); // 이 방식은 String으로
    ...
    public boolean getExiMember(String username) {
