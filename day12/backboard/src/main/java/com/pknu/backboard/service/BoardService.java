...
public class BoardService {
    ...
    // 페이징용 게시판 조회메서드
    // 정렬기능 추가 250703. ebs
    // 검색기능 추가, keyword 파라미터 추가 250707. ebs
    public Page<Board> getBoardList(int page, String keyword) {
        ...
        Pageable pageable = PageRequest.of(page, 10, Sort.by(sorts)); // 10 을 변경해서 한 페이지에 20, 30개도 표현가능
    ...
    public void setBoardOne(String title, String content, Member member, String originalName, String storedName,
            String savePath) {
    ...
    // UPDATE board SET ...
    public void putBoardOne(Board board, String title, String content, String originalName, String storedName,
            String savePath, boolean flag) {
