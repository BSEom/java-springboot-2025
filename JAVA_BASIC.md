...
- 데이터를 순차적으로 접근하기 떄문에 위치를 모르면 효율이 좋지 않음
...
- 모든 클래스의 조상 클래스. extends를 사용하지 않아도 항상 상속됨
    - java.lang.Object
    - Object 클래스가 가지고 있는 멤버변수와 메소드는 다 사용가능
...
- [Java문법실습](./day03/spring01/src/main/java/com/ebs0012/spring01/Spring01Application.java)

#### 예외처리
- 프로그램의 비정상적 종료를 막기위한 보호막
- 소스코드 상의 오류 : 에러/컴파일 에러. 수정이 용이
- 실행중 발생하는 오류 : 예외/런타임 에러. 수정이 어려움. 언제 발생하지 모름
...
##### 예외던지기
- 예외를 직접 처리하지않고 상위 클래스나 메서드에게 처리를 인가
...
- [Java문법실습](./day03/spring02/src/main/java/com/ebs0012/spring02/Spring02Application.java)
...
- [Java문법실습](./day03/spring04/src/main/java/com/ebs0012/spring04/Spring04Application.java)
...
- [Java문법실습](./day04/spring01/src/main/java/com/ebs0012/spring01/Spring01Application.java)
...
- [Java문법실습](./day04/spring02/src/main/java/com/ebs0012/spring02/Spring02Application.java)
...
- [Java문법실습](./day04/spring03/src/main/java/com/ebs0012/spring03/Spring03Application.java)
...
- [Java문법실습](./day04/spring04/src/main/java/com/ebs0012/spring04/Spring04Application.java)
...
- [Java문법실습](./day05/spring01/src/main/java/com/ebs0012/spring01/Spring01Application.java)

#### GC(Garbage Collection)
- C 등의 절차적 언어에서는 객체를 생성해서 메로리를 사용하면, 개발자가 직접 해제해줘야 함
- 메모리 누수가 발생
...
- 입출력 예외가 발생할 수 있기 때문에 글래스나 메서드에 `throws IOException`을 추가해야 함
- 파일읽기에 `FileInputStream`, `BufferedReader` 클래스 사용

- [Java문법실습](/day05/spring02/src/main/java/com/ebs0012/spring02/Spring02Application.java)
